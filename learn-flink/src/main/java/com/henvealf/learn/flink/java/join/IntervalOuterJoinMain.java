...
public class IntervalOuterJoinMain {
    ...
    public static void main(String[] args) throws Exception {
        ...
        SingleOutputStreamOperator<String> result =
                new IntervalOuterJoin<>(
                        streamA.keyBy(str -> str.substring(0, 1)),
                        streamB.keyBy(str -> str.substring(0, 1)),
                        IntervalOuterJoin.JoinType.OUTER)
